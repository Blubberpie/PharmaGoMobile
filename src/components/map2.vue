    ...
    <map-view class="map"
      ...
      <view class='toolbar' v-if='isPressForInfo'>
        ...
        <!-- <view :style="{justifyContent:'center', alignItems:'center',marginTop:30}">
         ...
         <switch :style="{position:'absolute',right:0,marginRight:0}" v-model="isEnabled" :trackColor="{ false: '#767577', true: '#00704A'}" />
        </view> -->
      </view>
      <view class='card' v-if="isUseCard">
        ...
        <view v-if="isPickUp">
          ...
          <!-- <view> -->
          <!-- <touchable-opacity :style="{backgroundColor:'grey',position:'absolute',right:0,padding:10,borderRadius:20}">
            <text :style="{color:'white',fontWeight:'bold'}">close</text>
          </touchable-opacity> -->
          <!-- </view> -->
        ...
        />
         ...
         <!-- <touchable-opacity :style="{backgroundColor:'grey',position:'absolute',right:0,padding:10,borderRadius:20,marginTop:20}">
            <text :style="{color:'white',fontWeight:'bold'}">close</text>
          </touchable-opacity> -->
        <view v-if="isDropOff">
...
export default {
    ...
    return {
      ...
      duration:0,
      pharmacy_name:'',
        GOOGLE_MAPS_APIKEY: 'AIzaSyD6LW_wQwi4ByWuPbBHPrzMCooQTip-X2Y',
